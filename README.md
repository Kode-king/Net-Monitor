...
لوحة مراقبة مبنية على **Next.js (JavaScript) + Tailwind** تجمع مقاييس الأداء (CPU / RAM / التخزين / حركة الشبكة / مدة التشغيل) من أجهزتك عبر **SNMP v1/v2c**، وتخزّنها في قاعدة بيانات SQLite محلية، وتعرضها في رسوم بيانية زمنية مع نظام تنبيهات وصلاحيات مستخدمين.
...
2. أدخل الاسم، العنوان/IP، النوع (سيرفر/سويتش/راوتر)، إصدار SNMP، و community string.
...
- community strings تُخزَّن كنص عادي في قاعدة البيانات المحلية — احمِ ملف `data/net-monitor.db`.
- استخدم SNMPv2c داخل شبكة موثوقة فقط؛ لا يدعم هذا الإصدار SNMPv3 بعد.
